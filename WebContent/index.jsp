            ...
            <div class="nav-inner">
                <a class="brand" href="#home" aria-label="Go home">
                    <span class="logo-mark"
                        style="background-image: url('<%=request.getContextPath()%>/assets/IMG_0519_copy.jpg');"></span>
        ...
        <section id="home" class="section hero">
            <div class="hero-inner reveal">
                <div>
                    ...
                    <p class="hero-sub">I’m passionate about backend systems, databases, big data, and cloud
                        technologies.</p>
                    <div class="hero-ctas">
                ...
                <div class="avatar-wrap">
                    <div class="avatar-ring">
                        <div class="avatar">
                            <img class="face-center" src="<%=request.getContextPath()%>/assets/IMG_0519_copy.jpg"
                                alt="Avatar"
            ...
            <div class="container profile-inner">
                ...
                <div class="profile-grid">
                    ...
                    <div class="profile-card card-personal">
                        ...
                        <p class="card-sub">Ho Chi Minh City University of Technology and Education (HCMUTE) —
                            Department of Information Technology</p>

                        <ul class="personal-list">
                            <li><strong>School:</strong> Ho Chi Minh City University of Technology and Education
                                (HCMUTE)</li>
                        ...
                        <p class="personal-desc" style="color:var(--muted-1);">
                            I’m <strong>Lê Trần Tuấn Anh</strong>, a Data Engineering student at HCMUTE. I build modern
                            full‑stack web applications and data systems; my core technologies include:
                            Frontend — HTML, CSS, JavaScript, React, Tailwind CSS, Chart.js; Backend — Java Servlet,
                            Node.js (Express, NestJS), Flask, Docker, AWS S3; Data Engineering — SQL Server, PostgreSQL,
                            MongoDB, Hadoop, Python, Flyway, and ETL tools.
                        </p>
                    </div>
                    ...
                    <div class="profile-side">
                        <div class="profile-card card-education">
                            ...
                            <div class="edu-item">
                                ...
                                <div class="edu-sub">Department of Information Technology — Data Engineering (2022–2026)
                                </div>
                                <div class="edu-list" style="color:var(--muted-1); margin-top:8px;">Notable coursework:
                                    Databases, Web Programming, Cloud Computing, Big Data Systems, Machine Learning.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="profile-card card-skills">
                            ...
                            <ul class="soft-skills" aria-label="Soft skills list">
                                <li><span class="tag-icon"><i class="fas fa-users"></i></span>
                                    <div><strong>Effective Teamwork</strong>
                                        <div style="color:var(--muted-1)">Collaborates effectively using GitHub
                                            workflows</div>
                                    </div>
                                </li>
                                <li><span class="tag-icon"><i class="fas fa-lightbulb"></i></span>
                                    <div><strong>Analytical Thinking</strong>
                                        <div style="color:var(--muted-1)">Proactively analyzes and resolves problems
                                        </div>
                                    </div>
                                </li>
                                <li><span class="tag-icon"><i class="fas fa-book-open"></i></span>
                                    <div><strong>Quick Learner</strong>
                                        <div style="color:var(--muted-1)">Researches new technologies and applies them
                                            to homework</div>
                                    </div>
                                </li>
                                <li><span class="tag-icon"><i class="fas fa-comments"></i></span>
                                    <div><strong>Clear Communication</strong>
                                        <div style="color:var(--muted-1)">Documents and presents ideas clearly</div>
                                    </div>
                                </li>
                                <li><span class="tag-icon"><i class="fas fa-clock"></i></span>
                                    <div><strong>Time Management</strong>
                                        <div style="color:var(--muted-1)">Effectively managing tasks and deadlines
                                            during semester homework</div>
                                    </div>
                                </li>
                            </ul>
            ...
            <div class="about reveal">
                <div class="avatar-frame">
                    <div class="avatar-border">
                        <img class="avatar-img face-center" src="<%=request.getContextPath()%>/assets/IMG_0519_copy.jpg"
                            alt="Avatar"
                            onerror="this.onerror=null;this.style.display='none';const p=this.parentElement; p.classList.add('img-missing'); p.innerHTML='<div class=\'avatar-fallback\'>TA</div>';" />
                    </div>
                </div>
        ...
        <section id="homework" class="section container">
            ...
            <div class="projects-grid reveal">
                <article class="project-card guardian proj-purple">
                    ...
                    <div class="project-actions"><a class="btn-sm btn-gh"
                            href="https://github.com/tuanh250105/new_web_project" target="_blank">Repo</a></div>
                </article>
                ...
                <article class="project-card guardian proj-purple">
                    ...
                    <div class="project-actions"><a class="btn-sm btn-gh"
                            href="https://ch04-ex1-survey-znrm.onrender.com/" target="_blank">Open</a></div>
                </article>
                ...
                <article class="project-card guardian proj-purple">
                    ...
                    <div class="project-actions"><a class="btn-sm btn-gh" href="https://email-app-chuong5.onrender.com/"
                ...
                <article class="project-card guardian proj-purple">
                    ...
                    <div class="project-actions"><a class="btn-sm btn-gh" href="https://ch-06.onrender.com/"
                            target="_blank">Open</a></div>
                </article>
                ...
                <article class="project-card guardian proj-purple">
                    ...
                    <div class="project-actions"><a class="btn-sm btn-gh" href="https://cart-web-ggq6.onrender.com/"
                            target="_blank">Open</a></div>
                </article>
                ...
                <article class="project-card guardian proj-purple">
                    ...
                    <div class="project-actions">
                        ...
                        <a class="btn-sm btn-gh" href="https://ch07-download-wids.onrender.com/"
                ...
                <article class="project-card guardian proj-purple">
                    ...
                    <div class="project-actions"><a class="btn-sm btn-gh" href="https://ch12-dmso.onrender.com/"
                            target="_blank">Open</a></div>
                </article>
                
                <article class="project-card guardian proj-purple">
                    <div class="project-media">CH14</div>
                    <h3 class="project-title">CH14 HK2E</h3>
                    <p class="project-desc">Chapter 14 — Email.</p>
                    <div class="project-actions"><a class="btn-sm btn-gh" href="https://ch14-hk2e.onrender.com/"
                            target="_blank">Open</a></div>
                </article>
            </div>
        ...
        <section id="connect" class="section container contact">
            ...
            <div class="contact-card reveal connect-card">
                ...
                <div class="socials" style="margin-top:12px;">
                    ...
                    <a href="https://www.facebook.com/lttuananh25" target="_blank" aria-label="Facebook"
                        class="social-link">
                        <!-- Facebook SVG (inlined) -->
                        <svg class="social-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                            fill="currentColor" aria-hidden="true">
                            <path
                                d="M22 12a10 10 0 1 0-11.5 9.9v-7h-2.2v-2.9h2.2V9.3c0-2.2 1.3-3.4 3.3-3.4.95 0 1.9.17 1.9.17v2.1h-1.06c-1.05 0-1.38.66-1.38 1.33v1.6h2.35l-.38 2.9h-1.97v7A10 10 0 0 0 22 12z" />
                        </svg>
                    </a>
            ...
            <div class="contact-card reveal contact-card--form">
                <h2>Contact</h2>
                <form id="contactForm" class="contact-form" action="<%=request.getContextPath()%>/contact" method="post"
                    ...
                    <div style="margin-top:12px; display:flex; align-items:center; gap:10px;">
                        <button id="sendBtn" type="button" class="btn btn-send"><span
                                id="sendLabel">Send</span></button>
